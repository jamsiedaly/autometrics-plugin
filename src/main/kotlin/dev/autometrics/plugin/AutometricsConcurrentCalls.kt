...
class AutometricsConcurrentCalls : AutometricsAction() {
    ...
    override fun actionPerformed(e: AnActionEvent) {
        ...
        val query = concurrentCallsQuery("function", "${methodInfo.className}.${methodInfo.methodName}")
        val url = makePrometheusUrl(query, "Function calls per minute")
        BrowserUtil.browse(url)
    }

    private fun concurrentCallsQuery(labelKey: String, labelValue: String): String {
